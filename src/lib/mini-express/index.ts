import http from 'http'; // Importa o módulo HTTP nativo do Node.js para criar um servidor HTTP.
...
// e um callback opcional `next` que, quando chamado, passa o controle para o próximo middleware.
